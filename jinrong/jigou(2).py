...
seed_url ='http://www.interotc.com/CASServer/login?service=http%3A%2F%2Fwww.interotc.cn%3A80%2Fuser%2Findex.do%3Fv%3Dnew'
#打开网址
driver.get(seed_url)
time.sleep(5)
...
# 输入密码
driver.find_element_by_xpath('//input[@class="pwdText"]').send_keys("4580DAF97D62603B59CC7D8D553B135748483FEF99E0EBF5")
#输入验证码
