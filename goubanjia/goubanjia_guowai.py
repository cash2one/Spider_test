...
class Goubanjia():
    def __init__(self,page):
        ...
        self.urls = ['http://www.goubanjia.com/free/gwgn/index{}.shtml'.format(i) for i in random.sample(range(1,101),page)]  # 全部免费代理
        # 构造请求头
        self.headers = {
        ...
        # 每次爬取ip，清空原ip文件
        with open('gwgnip.txt','w') as f:
            f.write('')
        # 创建一个文件用来存储ip
        self.file = open('gwgnip.txt','a')
